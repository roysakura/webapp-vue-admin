...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_tag__ = __webpack_require__(476);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        addTag: function addTag() {
            ...
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__api_tag__["g" /* addCategory */])(this.input).then(function (res) {
                if (res.status === 200) {
                    _this.showMsg("添加成功");
                    _this.input = '';
                }
...
// module
exports.push([module.i, ".add-tag-layout[data-v-7bbb497e]{width:330px;border:1px dashed #ccc;margin:0 auto}.btn-add-tag[data-v-7bbb497e],.tag-input[data-v-7bbb497e]{width:300px;display:block;margin:20px auto}", "", {"version":3,"sources":["D:/Products/vueAdmin-template-master/src/views/tag/mtag/addcategory.vue"],"names":[],"mappings":"AACA,iCACI,YAAa,AACb,uBAAwB,AACxB,aAAe,CAClB,AACD,0DACI,YAAa,AACb,cAAe,AACf,gBAAkB,CACrB","file":"addcategory.vue","sourcesContent":["\n.add-tag-layout[data-v-7bbb497e]{\n    width: 330px;\n    border: 1px dashed #ccc;\n    margin: 0 auto;\n}\n.tag-input[data-v-7bbb497e],.btn-add-tag[data-v-7bbb497e]{\n    width: 300px;\n    display: block;\n    margin: 20px auto;\n}\n"],"sourceRoot":""}]);
...
var update = __webpack_require__(338)("3dde160f", content, true);
...
//# sourceMappingURL=29.e58f8ff34230d2fa4875.js.map