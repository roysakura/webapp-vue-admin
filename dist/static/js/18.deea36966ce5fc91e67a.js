...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        add: function add() {
            ...
            var _this = this;
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__api_adv__["b" /* editAdv */])(this.$route.params.advId, this.adAdvName, this.adContent, true, this.adName, this.adLink, this.file, this.adDay).then(function (res) {
                _this3.showMsg("添加成功!", true);
                setTimeout(function () {
                    _this.$router.push({ path: '/adv/index', replace: true });
                }, 500);
            }, function (err) {
                _this3.showMsg("添加失败!", false);
            });
        },
...
//# sourceMappingURL=18.deea36966ce5fc91e67a.js.map