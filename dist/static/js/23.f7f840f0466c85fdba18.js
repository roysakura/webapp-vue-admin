...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue2_dropzone__ = __webpack_require__(825);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_adv__ = __webpack_require__(821);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getAdvId: function getAdvId() {
            this.initAdv(this.$route.params.advId);
        },
        initAdv: function initAdv(id) {
            var _this2 = this;

            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__api_adv__["a" /* getAdvById */])(id).then(function (res) {
                if (res.status === 200) {
                    _this2.adContent = res.data.data.detail.content;
                    _this2.adName = res.data.data.detail.company;
                    _this2.adPicAddress = res.data.data.detail.image_link;
                    _this2.adDay = res.data.data.detail.days;
                    _this2.adAdvName = res.data.data.detail.ad_name;
                    _this2.adLink = res.data.data.detail.ad_link;
                    _this2.file = res.data.data.detail.image_link;
                    _this2.adAddress = res.data.data.detail.position;
                }
            }, function (err) {});
        },
        add: function add() {
            ...
            var _this = this;
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__api_adv__["b" /* editAdv */])(this.$route.params.advId, this.adAdvName, this.adContent, true, this.adName, this.adLink, this.file, this.adDay, this.adAddress).then(function (res) {
                _this3.showMsg("编辑成功!", true);
                setTimeout(function () {
                    _this.$router.push({ path: '/adv/index', replace: true });
                }, 500);
            }, function (err) {
                _this3.showMsg("编辑失败!", false);
            });
        },
...
// module
exports.push([module.i, ".adv-add-layout[data-v-568b7968]{padding:20px}.adv-add-layout>.add-adv-info[data-v-568b7968]{font-size:20px;box-shadow:2px 2px 6px #ccc;padding-left:10px}.adv-add-layout>.adv-add-content[data-v-568b7968]{margin-top:20px;padding:4px;border:1px dashed #ccc}#myVueDropzone[data-v-568b7968],.adv-add-content>.adv-input[data-v-568b7968]{margin-top:10px}.btn-add-adv[data-v-568b7968]{width:300px;margin:20px auto;display:block}", "", {"version":3,"sources":["D:/Products/vueAdmin-template-master/src/views/adv/madv/editadv.vue"],"names":[],"mappings":"AACA,iCACI,YAAc,CACjB,AACD,+CACI,eAAgB,AAChB,4BAA6B,AAC7B,iBAAmB,CACtB,AACD,kDACI,gBAAiB,AACjB,YAAa,AACb,sBAAwB,CAC3B,AAID,6EACI,eAAiB,CACpB,AACD,8BACI,YAAa,AACb,iBAAkB,AAClB,aAAe,CAClB","file":"editadv.vue","sourcesContent":["\n.adv-add-layout[data-v-568b7968]{\n    padding: 20px;\n}\n.adv-add-layout>.add-adv-info[data-v-568b7968]{\n    font-size: 20px;\n    box-shadow: 2px 2px 6px #ccc;\n    padding-left: 10px;\n}\n.adv-add-layout> .adv-add-content[data-v-568b7968]{\n    margin-top: 20px;\n    padding: 4px;\n    border: 1px dashed #ccc;\n}\n.adv-add-content >.adv-input[data-v-568b7968]{\n    margin-top: 10px;\n}\n#myVueDropzone[data-v-568b7968]{\n    margin-top: 10px;\n}\n.btn-add-adv[data-v-568b7968]{\n    width: 300px;\n    margin: 20px auto;\n    display: block;\n}\n"],"sourceRoot":""}]);
...
var update = __webpack_require__(338)("150bc0d8", content, true);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), _vm._m(0), _vm._v(" "), _c('dropzone', {
    ref: "file",
    attrs: {
...
//# sourceMappingURL=23.f7f840f0466c85fdba18.js.map